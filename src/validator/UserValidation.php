...
class UserValidation
{
    ...
    public const INTERESSE_ERROR_REQUIRED_MSG ='L\'interesse è obbligatorio';
    public const INTERESSE_ERROR_NONE_MSG = '';
    ...
    private function validate()
    {
        ...
        // $this->errors['interesse'] = $this->validateInteresse();
    }
    ...
    // private function validateInteresse(): ?ValidationResult
    // {
    //     $interesse = $this->interesse->getInteresseId();
    //     if(empty($interesse)){
    //         return new ValidationResult(self::INTERESSE_ERROR_REQUIRED_MSG, false, $interesse);
    //     }else{
